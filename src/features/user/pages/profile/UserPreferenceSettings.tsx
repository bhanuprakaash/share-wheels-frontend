...
} from "../../hooks/useUserPreferences.ts";
...
const UserPreferenceSettings = () => {
  const [preferenceData, setPreferenceData] =
    useState<UpdateUserPreferencePayload>({});
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <form
        ...
        className="flex flex-col gap-4 border-1 border-[#E8F2E8] w-full p-4 rounded-lg"
      >
        <ArrayStringInput
          label="Music Genre"
        ...
        <Button
          ...
          variant={"primary"}
          customClasses={
            "text-base mt-3 font-semibold ml-2 flex items-center w-[150px]"
          }
